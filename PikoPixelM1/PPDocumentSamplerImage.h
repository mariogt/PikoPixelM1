...
@interface PPDocumentSamplerImage : NSObject <NSCoding, NSCopying>
{
    NSBitmapImageRep *_bitmap;
    NSImage *_image;
    NSData *_compressedBitmapData;

    NSUInteger _hash;
    float _scalingFactorsForPanels[kNumPPSamplerImagePanelTypes];
}
