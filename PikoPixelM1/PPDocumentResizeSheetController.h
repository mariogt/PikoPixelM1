/*
    PPDocumentResizeSheetController.h
...
@interface PPDocumentResizeSheetController : PPDocumentSheetController
{
    IBOutlet NSTextField *_widthTextField;
    IBOutlet NSTextField *_heightTextField;
    IBOutlet NSButton *_shouldScaleCheckbox;
...
@interface NSObject (PPDocumentResizeSheetDelegateMethods)
