...
@interface PPTitleablePopUpButton : NSPopUpButton
{
    id _delegate;

    NSMenu *_popupMenu;
    NSInteger _indexOfSelectedPopupMenuItem;
}
...
@interface NSObject (PPTitleablePopUpButtonDelegateMethods)
