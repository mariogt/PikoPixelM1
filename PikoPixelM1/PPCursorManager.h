...
#import "PPCursorLevel.h"


@interface PPCursorManager : NSObject
{
    NSCursor *_cursors[kNumPPCursorLevels];

    NSCursor *_currentCursor;
    PPCursorLevel _currentCursorLevel;

    NSCursor *_defaultCursor;

    NSWindow *_currentDocumentWindow;
