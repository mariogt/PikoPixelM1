...
@interface PPNavigatorPopupView : PPThumbnailImageView
{
    ...
    NSRect _visibleCanvasBoundsTrackingRect;
    NSTrackingRectTag _visibleCanvasBoundsTrackingRectTag;

    bool _windowIsVisible;

    bool _needToRedrawView;

    bool _mouseIsDraggingVisibleBounds;

    bool _mouseIsInsideViewBoundsTrackingRect;
